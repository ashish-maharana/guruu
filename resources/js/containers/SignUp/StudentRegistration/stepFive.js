...
export default function StepFive(props) {
  ...
  const studentsPreferences = SignupState.learn.data;
  useEffect(() => {
    dispatch(actions.getLearningPreferences({}));
  }, []);
  return (
    <Formik
      initialValues={initialValues}
      validator={learnValidate}
      onSubmit={(values) => {
        dispatch(actions.learn(values));
      }}
    >
      {(formik) => {
        const {
        ...
        useEffect(() => {
          if (studentsPreferences) {
            setFieldValue(
              "learn",
              studentsPreferences.learn ? studentsPreferences.learn : "",
              false
            );
          }
        }, [studentsPreferences]);
            ...
            <div className="row justify-content-center">
              <div className="col-lg-12 col-md-12">
                ...
                <h3 className="modal-subheading text-center mb-4">
                  Choose one or more subjects you'd like to learn
                </h3>
                <Form className="mt-4">
