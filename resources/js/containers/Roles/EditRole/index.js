...
import {makeSelectErrors, makeSelectSingleRole} from "../Roles/selectors";
import makeRoles from "../Roles/selectors";
...
export default function EditRole() {
    ...
    const roleData = useSelector(makeRoles());

    const { id } = useParams();

    useEffect(() => {
        dispatch(actions.singleRole(id));
    }, []);
        ...
        <Layout>
            ...
            >
                {(formik) => {
                    ...
                    useEffect(() => {
                        if (roleData) {
                            setFieldValue("name", roleData.data.name, false);
                        }
                    }, [roleData]);
